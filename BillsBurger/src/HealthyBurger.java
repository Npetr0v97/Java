public class HealthyBurger extends BaseBurger {
    ...
    public void printBurgerStats(){
        ...
        System.out.println("Burger stats:\n------------------------ \nYour burger is made of " + this.getBreadType() + " bread with " +
                this.getMeatType() + " meat at the price of " +String.format("%.2f",this.getBasePrice()) + " BGN\n\n");
        ...
        this.setBurgerPrice(this.getBasePrice()+this.getLettuceQuantity()*this.getLettucePrice()+
        ...
        System.out.println("Final price: "+this.getBurgerPrice());

    }

    public void setEggsQuantity() {
        this.eggsQuantity++;
    }

    public void setPicklesQuantity() {
