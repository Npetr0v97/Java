...
*/
        ...
        Set<HeavenlyBodyClass> planets = new HashSet<>();
        HeavenlyBodyClass tempHeavenlyBody = new HeavenlyBodyClass("Earth", 365, HeavenlyBodyClass.PLANET);
        planets.add(tempHeavenlyBody);

        tempHeavenlyBody = new HeavenlyBodyClass("Venus", 225, HeavenlyBodyClass.MOON);
        planets.add(tempHeavenlyBody);

        tempHeavenlyBody = new HeavenlyBodyClass("Earth", 365, HeavenlyBodyClass.PLANET);
        planets.add(tempHeavenlyBody);

        for (HeavenlyBodyClass planet : planets) {
